...
program.add_func("add_i8", (), pt.Int8_t, [
...
program.add_func("add_i32", (), pt.Int32_t, [
    ...
    def test_mismatch_type_add(self):
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Add(pt.Int8(2), pt.Int32(2))),
            ])
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Add(pt.Int32(2), pt.Int8(2))),
            ])

    def test_mismatch_type_sub(self):
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Sub(pt.Int8(2), pt.Int32(2))),
            ])
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Sub(pt.Int32(2), pt.Int8(2))),
            ])

    def test_mismatch_type_mul(self):
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Mul(pt.Int8(2), pt.Int32(2))),
            ])
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Mul(pt.Int32(2), pt.Int8(2))),
            ])

    def test_mismatch_type_div(self):
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Div(pt.Int8(2), pt.Int32(2))),
            ])
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Div(pt.Int32(2), pt.Int8(2))),
            ])

    def test_mismatch_type_mod(self):
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Mod(pt.Int8(2), pt.Int32(2))),
            ])
        with self.assertRaises(pt.TypeException):
            pt.Program("module").add_func("foo", (), pt.Int32_t, [
                pt.Return(pt.Mod(pt.Int32(2), pt.Int8(2))),
            ])
