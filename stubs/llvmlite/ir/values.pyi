...
class DIValue(NamedValue):
    ...
    kind: Any = ...
    operands: Any = ...
    def __init__(self, parent: Any, is_distinct: Any, kind: Any, operands: Any, name: Any) -> None: ...
    def descr(self, buf: Any) -> None: ...
    def __eq__(self, other: Any) -> Any: ...
    def __ne__(self, other: Any) -> Any: ...
    def __hash__(self) -> Any: ...
...
class GlobalVariable(GlobalValue):
    ...
    addrspace: Any = ...
    align: Any = ...
    def __init__(self, module: Any, typ: Any, name: Any, addrspace: int = ...) -> None: ...
    def descr(self, buf: Any) -> None: ...
...
class Function(GlobalValue, _HasMetadata):
    ...
    def insert_basic_block(self, before: Any, name: str = ...): ...
