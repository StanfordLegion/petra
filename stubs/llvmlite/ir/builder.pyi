...
class IRBuilder:
    ...
    def if_then(self, pred: Any, likely: Optional[Any] = ...) -> Any: ...
    def if_else(self, pred: Any, likely: Optional[Any] = ...) -> Any: ...
    ...
    def sadd_with_overflow(self, lhs: Any, rhs: Any, name: str = ...) -> instructions.Instruction: ...
    def smul_with_overflow(self, lhs: Any, rhs: Any, name: str = ...) -> instructions.Instruction: ...
    def ssub_with_overflow(self, lhs: Any, rhs: Any, name: str = ...) -> instructions.Instruction: ...
    def uadd_with_overflow(self, lhs: Any, rhs: Any, name: str = ...) -> instructions.Instruction: ...
    def umul_with_overflow(self, lhs: Any, rhs: Any, name: str = ...) -> instructions.Instruction: ...
    def usub_with_overflow(self, lhs: Any, rhs: Any, name: str = ...) -> instructions.Instruction: ...
    def not_(self, value: Any, name: str = ...): ...
    def neg(self, value: Any, name: str = ...): ...
    def icmp_signed(self, cmpop: Any, lhs: Any, rhs: Any, name: str = ...) -> instructions.ICMPInstr: ...
    def icmp_unsigned(self, cmpop: Any, lhs: Any, rhs: Any, name: str = ...) -> instructions.ICMPInstr: ...
    def fcmp_ordered(self, cmpop: Any, lhs: Any, rhs: Any, name: str = ..., flags: Any = ...): ...
    def fcmp_unordered(self, cmpop: Any, lhs: Any, rhs: Any, name: str = ..., flags: Any = ...): ...
    ...
    def alloca(self, typ: Any, size: Optional[Any] = ..., name: str = ...): ...
    def load(self, ptr: Any, name: str = ..., align: Optional[Any] = ...) -> instructions.LoadInstr: ...
    def store(self, value: Any, ptr: Any, align: Optional[Any] = ...): ...
    ...
    def call(self, fn: Any, args: Any, name: str = ..., cconv: Optional[Any] = ..., tail: bool = ..., fastmath: Any = ...) -> instructions.CallInstr: ...
    def asm(self, ftype: Any, asm: Any, constraint: Any, args: Any, side_effect: Any, name: str = ...): ...
    def load_reg(self, reg_type: Any, reg_name: Any, name: str = ...): ...
    def store_reg(self, value: Any, reg_type: Any, reg_name: Any, name: str = ...): ...
    def invoke(self, fn: Any, args: Any, normal_to: Any, unwind_to: Any, name: str = ..., cconv: Optional[Any] = ..., tail: bool = ...): ...
    ...
    def shuffle_vector(self, vector1: Any, vector2: Any, mask: Any, name: str = ...): ...
    ...
    def atomic_rmw(self, op: Any, ptr: Any, val: Any, ordering: Any, name: str = ...): ...
    def cmpxchg(self, ptr: Any, cmp: Any, val: Any, ordering: Any, failordering: Optional[Any] = ..., name: str = ...): ...
    def landingpad(self, typ: Any, name: str = ..., cleanup: bool = ...): ...
    def assume(self, cond: Any): ...
    def fence(self, ordering: Any, targetscope: Optional[Any] = ..., name: str = ...): ...
