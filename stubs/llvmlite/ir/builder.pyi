...
class IRBuilder:
    ...
    def frem(self, lhs: Any, rhs: Any, name: str = ...) -> Any: ...
    ...
    def icmp_signed(self, cmpop: Any, lhs: Any, rhs: Any, name: str = ...): ...
    def icmp_unsigned(self, cmpop: Any, lhs: Any, rhs: Any, name: str = ...): ...
    ...
    def load(self, ptr: Any, name: str = ..., align: Optional[Any] = ...): ...
    ...
    def call(self, fn: Any, args: Any, name: str = ..., cconv: Optional[Any] = ..., tail: bool = ..., fastmath: Any = ...): ...
