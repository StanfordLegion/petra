...
class IRBuilder:
    ...
    def if_then(
        self, pred: values.Value, likely: Optional[bool] = ...
    ) -> ContextManager[values.Block]: ...
    def if_else(
        self, pred: values.Value, likely: Optional[bool] = ...
    ) -> ContextManager[
        Tuple[ContextManager[values.Block], ContextManager[values.Block]]
    ]: ...
